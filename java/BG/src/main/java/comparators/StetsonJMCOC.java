...
public class StetsonJMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public StetsonJMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.StetsonJ;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getStetsonJ();
            referenceValue = ((VarstarsRef) ref).getStetsonJ();
