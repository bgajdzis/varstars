...
public class BlsSignalToPinkNoise1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsSignalToPinkNoise1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsSignalToPinkNoise1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsSignalToPinkNoise1();
            referenceValue = ((VarstarsRef) ref).getBlsSignalToPinkNoise1();
