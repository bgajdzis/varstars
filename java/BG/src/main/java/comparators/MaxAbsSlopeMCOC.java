...
public class MaxAbsSlopeMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public MaxAbsSlopeMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.MaxAbsSlope;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getMaxAbsSlope();
            referenceValue = ((VarstarsRef) ref).getMaxAbsSlope();
