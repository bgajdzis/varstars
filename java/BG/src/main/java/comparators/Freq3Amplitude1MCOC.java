...
public class Freq3Amplitude1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq3Amplitude1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq3Amplitude1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq3Amplitude1();
            referenceValue = ((VarstarsRef) ref).getFreq3Amplitude1();
