...
public class CadProbs50000MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs50000MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs50000;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs50000();
            referenceValue = ((VarstarsRef) ref).getCadProbs50000();
