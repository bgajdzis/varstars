...
public class P2pScatterOverMadMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public P2pScatterOverMadMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.P2pScatterOverMad;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getP2pScatterOverMad();
            referenceValue = ((VarstarsRef) ref).getP2pScatterOverMad();
