...
public class FreqSignifRatio31MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public FreqSignifRatio31MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.FreqSignifRatio31;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreqSignifRatio31();
            referenceValue = ((VarstarsRef) ref).getFreqSignifRatio31();
