...
public class BlsWhiteNoise2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsWhiteNoise2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsWhiteNoise2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsWhiteNoise2();
            referenceValue = ((VarstarsRef) ref).getBlsWhiteNoise2();
