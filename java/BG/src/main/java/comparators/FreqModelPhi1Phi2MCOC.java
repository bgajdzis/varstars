...
public class FreqModelPhi1Phi2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public FreqModelPhi1Phi2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.FreqModelPhi1Phi2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreqModelPhi1Phi2();
            referenceValue = ((VarstarsRef) ref).getFreqModelPhi1Phi2();
