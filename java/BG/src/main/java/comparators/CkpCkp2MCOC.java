...
public class CkpCkp2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CkpCkp2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CkpCkp2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCkpCkp2();
            referenceValue = ((VarstarsRef) ref).getCkpCkp2();
