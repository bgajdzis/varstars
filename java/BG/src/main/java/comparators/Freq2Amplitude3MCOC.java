...
public class Freq2Amplitude3MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq2Amplitude3MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq2Amplitude3;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq2Amplitude3();
            referenceValue = ((VarstarsRef) ref).getFreq2Amplitude3();
