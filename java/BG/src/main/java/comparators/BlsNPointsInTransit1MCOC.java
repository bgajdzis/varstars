...
public class BlsNPointsInTransit1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsNPointsInTransit1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsNPointsInTransit1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsNPointsInTransit1();
            referenceValue = ((VarstarsRef) ref).getBlsNPointsInTransit1();
