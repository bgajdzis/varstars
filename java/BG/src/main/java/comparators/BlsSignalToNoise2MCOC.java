...
public class BlsSignalToNoise2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsSignalToNoise2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsSignalToNoise2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsSignalToNoise2();
            referenceValue = ((VarstarsRef) ref).getBlsSignalToNoise2();
