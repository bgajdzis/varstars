...
public class P2pScatter2prawMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public P2pScatter2prawMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.P2pScatter2praw;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getP2pScatter2praw();
            referenceValue = ((VarstarsRef) ref).getP2pScatter2praw();
