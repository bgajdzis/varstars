...
public class BlsSignalResidue1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsSignalResidue1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsSignalResidue1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsSignalResidue1();
            referenceValue = ((VarstarsRef) ref).getBlsSignalResidue1();
