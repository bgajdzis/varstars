...
public class FreqFrequencyRatio21MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public FreqFrequencyRatio21MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.FreqFrequencyRatio21;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreqFrequencyRatio21();
            referenceValue = ((VarstarsRef) ref).getFreqFrequencyRatio21();
