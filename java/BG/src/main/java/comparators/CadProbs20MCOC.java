...
public class CadProbs20MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs20MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs20;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs20();
            referenceValue = ((VarstarsRef) ref).getCadProbs20();
