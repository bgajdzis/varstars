...
public class Freq3RelPhase4MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq3RelPhase4MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq3RelPhase4;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq3RelPhase4();
            referenceValue = ((VarstarsRef) ref).getFreq3RelPhase4();
