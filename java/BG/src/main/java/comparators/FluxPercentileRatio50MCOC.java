...
public class FluxPercentileRatio50MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public FluxPercentileRatio50MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.FluxPercentileRatio50;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFluxPercentileRatio50();
            referenceValue = ((VarstarsRef) ref).getFluxPercentileRatio50();
