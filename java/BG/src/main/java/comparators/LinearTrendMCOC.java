...
public class LinearTrendMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public LinearTrendMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.LinearTrend;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getLinearTrend();
            referenceValue = ((VarstarsRef) ref).getLinearTrend();
