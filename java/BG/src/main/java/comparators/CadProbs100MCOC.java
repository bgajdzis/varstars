...
public class CadProbs100MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs100MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs100;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs100();
            referenceValue = ((VarstarsRef) ref).getCadProbs100();
