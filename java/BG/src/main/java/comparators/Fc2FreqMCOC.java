...
public class Fc2FreqMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Fc2FreqMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Fc2Freq;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFc2Freq();
            referenceValue = ((VarstarsRef) ref).getFc2Freq();
