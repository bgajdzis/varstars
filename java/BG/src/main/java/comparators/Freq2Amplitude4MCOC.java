...
public class Freq2Amplitude4MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq2Amplitude4MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq2Amplitude4;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq2Amplitude4();
            referenceValue = ((VarstarsRef) ref).getFreq2Amplitude4();
