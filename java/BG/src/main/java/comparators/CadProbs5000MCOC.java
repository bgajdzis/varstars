...
public class CadProbs5000MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs5000MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs5000;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs5000();
            referenceValue = ((VarstarsRef) ref).getCadProbs5000();
