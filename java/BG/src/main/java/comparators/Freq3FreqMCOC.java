...
public class Freq3FreqMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq3FreqMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq3Freq;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq3Freq();
            referenceValue = ((VarstarsRef) ref).getFreq3Freq();
