...
public class CadProbs500MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs500MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs500;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs500();
            referenceValue = ((VarstarsRef) ref).getCadProbs500();
