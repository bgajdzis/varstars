...
public class CadProbs50MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs50MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs50;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs50();
            referenceValue = ((VarstarsRef) ref).getCadProbs50();
