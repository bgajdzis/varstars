...
public class BlsNTransits1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsNTransits1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsNTransits1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsNTransits1();
            referenceValue = ((VarstarsRef) ref).getBlsNTransits1();
