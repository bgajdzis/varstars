...
public class ErrWeightedAvgMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public ErrWeightedAvgMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.ErrWeightedAvg;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getErrWeightedAvg();
            referenceValue = ((VarstarsRef) ref).getErrWeightedAvg();
