...
public class BlsFracOneNight2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsFracOneNight2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsFracOneNight2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsFracOneNight2();
            referenceValue = ((VarstarsRef) ref).getBlsFracOneNight2();
