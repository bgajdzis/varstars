...
public class CkpCkp1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CkpCkp1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CkpCkp1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCkpCkp1();
            referenceValue = ((VarstarsRef) ref).getCkpCkp1();
