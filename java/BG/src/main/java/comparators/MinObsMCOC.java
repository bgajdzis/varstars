...
public class MinObsMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public MinObsMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.MinObs;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getMinObs();
            referenceValue = ((VarstarsRef) ref).getMinObs();
