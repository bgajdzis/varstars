...
public class StetsonKMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public StetsonKMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.StetsonK;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getStetsonK();
            referenceValue = ((VarstarsRef) ref).getStetsonK();
