...
public class MeanMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public MeanMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Mean;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getMean();
            referenceValue = ((VarstarsRef) ref).getMean();
