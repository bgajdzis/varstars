...
public class BlsWhiteNoise1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsWhiteNoise1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsWhiteNoise1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsWhiteNoise1();
            referenceValue = ((VarstarsRef) ref).getBlsWhiteNoise1();
