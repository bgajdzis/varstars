...
public class Fc2Sin2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Fc2Sin2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Fc2Sin2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFc2Sin2();
            referenceValue = ((VarstarsRef) ref).getFc2Sin2();
