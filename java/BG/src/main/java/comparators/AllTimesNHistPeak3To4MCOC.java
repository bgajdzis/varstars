...
public class AllTimesNHistPeak3To4MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public AllTimesNHistPeak3To4MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.AllTimesNHistPeak3To4;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getAllTimesNHistPeak3To4();
            referenceValue = ((VarstarsRef) ref).getAllTimesNHistPeak3To4();
