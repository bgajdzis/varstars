...
public class BlsFracOneNight1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsFracOneNight1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsFracOneNight1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsFracOneNight1();
            referenceValue = ((VarstarsRef) ref).getBlsFracOneNight1();
