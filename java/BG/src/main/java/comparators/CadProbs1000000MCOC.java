...
public class CadProbs1000000MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs1000000MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs1000000;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs1000000();
            referenceValue = ((VarstarsRef) ref).getCadProbs1000000();
