...
public class BlsI22MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsI22MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsI22;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsI22();
            referenceValue = ((VarstarsRef) ref).getBlsI22();
