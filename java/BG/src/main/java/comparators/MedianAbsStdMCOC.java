...
public class MedianAbsStdMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public MedianAbsStdMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.MedianAbsStd;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getMedianAbsStd();
            referenceValue = ((VarstarsRef) ref).getMedianAbsStd();
