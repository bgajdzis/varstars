...
public class CadProbs10000000MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs10000000MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs10000000;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs10000000();
            referenceValue = ((VarstarsRef) ref).getCadProbs10000000();
