...
public class BlsMeanMagMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsMeanMagMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsMeanMag;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsMeanMag();
            referenceValue = ((VarstarsRef) ref).getBlsMeanMag();
