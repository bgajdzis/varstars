...
public class BlsNPointsAfterTransit1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsNPointsAfterTransit1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsNPointsAfterTransit1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsNPointsAfterTransit1();
            referenceValue = ((VarstarsRef) ref).getBlsNPointsAfterTransit1();
