...
public class CadProbs1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs1();
            referenceValue = ((VarstarsRef) ref).getCadProbs1();
