...
public class Freq2FreqMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq2FreqMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq2Freq;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq2Freq();
            referenceValue = ((VarstarsRef) ref).getFreq2Freq();
