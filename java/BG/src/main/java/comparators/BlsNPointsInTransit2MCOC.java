...
public class BlsNPointsInTransit2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsNPointsInTransit2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsNPointsInTransit2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsNPointsInTransit2();
            referenceValue = ((VarstarsRef) ref).getBlsNPointsInTransit2();
