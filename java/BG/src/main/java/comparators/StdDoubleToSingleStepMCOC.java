...
public class StdDoubleToSingleStepMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public StdDoubleToSingleStepMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.StdDoubleToSingleStep;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getStdDoubleToSingleStep();
            referenceValue = ((VarstarsRef) ref).getStdDoubleToSingleStep();
