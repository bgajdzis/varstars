...
public class NEpochsMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public NEpochsMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.NEpochs;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getNEpochs();
            referenceValue = ((VarstarsRef) ref).getNEpochs();
