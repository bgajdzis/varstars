...
public class BlsNTransits2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsNTransits2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsNTransits2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsNTransits2();
            referenceValue = ((VarstarsRef) ref).getBlsNTransits2();
