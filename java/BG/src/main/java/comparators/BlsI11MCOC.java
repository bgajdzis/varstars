...
public class BlsI11MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsI11MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsI11;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsI11();
            referenceValue = ((VarstarsRef) ref).getBlsI11();
