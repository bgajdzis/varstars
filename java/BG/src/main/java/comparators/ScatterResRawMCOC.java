...
public class ScatterResRawMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public ScatterResRawMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.ScatterResRaw;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getScatterResRaw();
            referenceValue = ((VarstarsRef) ref).getScatterResRaw();
