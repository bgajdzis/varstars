...
public class Freq2RelPhase3MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq2RelPhase3MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq2RelPhase3;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq2RelPhase3();
            referenceValue = ((VarstarsRef) ref).getFreq2RelPhase3();
