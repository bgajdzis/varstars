...
public class ObsSkewMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public ObsSkewMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.ObsSkew;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getObsSkew();
            referenceValue = ((VarstarsRef) ref).getObsSkew();
