...
public class Freq2RelPhase2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq2RelPhase2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq2RelPhase2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq2RelPhase2();
            referenceValue = ((VarstarsRef) ref).getFreq2RelPhase2();
