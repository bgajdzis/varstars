...
public class Freq3RelPhase3MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq3RelPhase3MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq3RelPhase3;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq3RelPhase3();
            referenceValue = ((VarstarsRef) ref).getFreq3RelPhase3();
