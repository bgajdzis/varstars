...
public class CadProbs100000MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs100000MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs100000;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs100000();
            referenceValue = ((VarstarsRef) ref).getCadProbs100000();
