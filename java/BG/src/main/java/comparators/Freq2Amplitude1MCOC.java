...
public class Freq2Amplitude1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq2Amplitude1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq2Amplitude1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq2Amplitude1();
            referenceValue = ((VarstarsRef) ref).getFreq2Amplitude1();
