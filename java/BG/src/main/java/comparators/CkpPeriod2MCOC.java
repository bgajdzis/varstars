...
public class CkpPeriod2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CkpPeriod2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CkpPeriod2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCkpPeriod2();
            referenceValue = ((VarstarsRef) ref).getCkpPeriod2();
