...
public class CadProbs10MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs10MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs10;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs10();
            referenceValue = ((VarstarsRef) ref).getCadProbs10();
