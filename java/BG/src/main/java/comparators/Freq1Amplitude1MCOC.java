...
public class Freq1Amplitude1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq1Amplitude1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq1Amplitude1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq1Amplitude1();
            referenceValue = ((VarstarsRef) ref).getFreq1Amplitude1();
