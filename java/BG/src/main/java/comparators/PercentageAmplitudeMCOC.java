...
public class PercentageAmplitudeMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public PercentageAmplitudeMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.PercentageAmplitude;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getPercentageAmplitude();
            referenceValue = ((VarstarsRef) ref).getPercentageAmplitude();
