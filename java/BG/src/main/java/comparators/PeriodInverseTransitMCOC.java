...
public class PeriodInverseTransitMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public PeriodInverseTransitMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.PeriodInverseTransit;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getPeriodInverseTransit();
            referenceValue = ((VarstarsRef) ref).getPeriodInverseTransit();
