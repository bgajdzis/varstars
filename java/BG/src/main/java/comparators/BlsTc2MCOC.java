...
public class BlsTc2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsTc2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsTc2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsTc2();
            referenceValue = ((VarstarsRef) ref).getBlsTc2();
