...
public class AllTimesNHistPeak1BinMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public AllTimesNHistPeak1BinMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.AllTimesNHistPeak1Bin;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getAllTimesNHistPeak1Bin();
            referenceValue = ((VarstarsRef) ref).getAllTimesNHistPeak1Bin();
