...
public class BlsNPointsBeforeTransit2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsNPointsBeforeTransit2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsNPointsBeforeTransit2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsNPointsBeforeTransit2();
            referenceValue = ((VarstarsRef) ref).getBlsNPointsBeforeTransit2();
