...
public class FreqFrequencyRatio31MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public FreqFrequencyRatio31MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.FreqFrequencyRatio31;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreqFrequencyRatio31();
            referenceValue = ((VarstarsRef) ref).getFreqFrequencyRatio31();
