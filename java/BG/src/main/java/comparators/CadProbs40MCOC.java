...
public class CadProbs40MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs40MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs40;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs40();
            referenceValue = ((VarstarsRef) ref).getCadProbs40();
