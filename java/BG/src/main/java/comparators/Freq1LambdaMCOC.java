...
public class Freq1LambdaMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq1LambdaMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq1Lambda;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq1Lambda();
            referenceValue = ((VarstarsRef) ref).getFreq1Lambda();
