...
public class BlsRedNoise2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsRedNoise2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsRedNoise2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsRedNoise2();
            referenceValue = ((VarstarsRef) ref).getBlsRedNoise2();
