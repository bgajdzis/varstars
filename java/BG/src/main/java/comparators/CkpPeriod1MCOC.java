...
public class CkpPeriod1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CkpPeriod1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CkpPeriod1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCkpPeriod1();
            referenceValue = ((VarstarsRef) ref).getCkpPeriod1();
