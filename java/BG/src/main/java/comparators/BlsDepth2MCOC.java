...
public class BlsDepth2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsDepth2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsDepth2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsDepth2();
            referenceValue = ((VarstarsRef) ref).getBlsDepth2();
