...
public class BlsTc1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsTc1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsTc1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsTc1();
            referenceValue = ((VarstarsRef) ref).getBlsTc1();
