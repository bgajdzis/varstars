...
public class Freq1RelPhase3MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq1RelPhase3MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq1RelPhase3;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq1RelPhase3();
            referenceValue = ((VarstarsRef) ref).getFreq1RelPhase3();
