...
public class BlsDeltaChi21MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsDeltaChi21MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsDeltaChi21;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsDeltaChi21();
            referenceValue = ((VarstarsRef) ref).getBlsDeltaChi21();
