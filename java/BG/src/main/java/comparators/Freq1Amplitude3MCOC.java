...
public class Freq1Amplitude3MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq1Amplitude3MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq1Amplitude3;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq1Amplitude3();
            referenceValue = ((VarstarsRef) ref).getFreq1Amplitude3();
