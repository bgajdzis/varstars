...
public class FreqModelMaxDeltaMagsMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public FreqModelMaxDeltaMagsMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.FreqModelMaxDeltaMags;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreqModelMaxDeltaMags();
            referenceValue = ((VarstarsRef) ref).getFreqModelMaxDeltaMags();
