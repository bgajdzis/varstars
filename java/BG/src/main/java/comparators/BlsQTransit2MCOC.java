...
public class BlsQTransit2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsQTransit2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsQTransit2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsQTransit2();
            referenceValue = ((VarstarsRef) ref).getBlsQTransit2();
