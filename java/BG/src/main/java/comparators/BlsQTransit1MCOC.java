...
public class BlsQTransit1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsQTransit1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsQTransit1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsQTransit1();
            referenceValue = ((VarstarsRef) ref).getBlsQTransit1();
