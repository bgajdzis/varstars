...
public class CadProbs30MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs30MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs30;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs30();
            referenceValue = ((VarstarsRef) ref).getCadProbs30();
