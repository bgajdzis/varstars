...
public class BlsNPointsBeforeTransit1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsNPointsBeforeTransit1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsNPointsBeforeTransit1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsNPointsBeforeTransit1();
            referenceValue = ((VarstarsRef) ref).getBlsNPointsBeforeTransit1();
