...
public class FreqYOffsetMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public FreqYOffsetMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.FreqYOffset;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreqYOffset();
            referenceValue = ((VarstarsRef) ref).getFreqYOffset();
