...
public class FluxPercentileRatio35MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public FluxPercentileRatio35MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.FluxPercentileRatio35;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFluxPercentileRatio35();
            referenceValue = ((VarstarsRef) ref).getFluxPercentileRatio35();
