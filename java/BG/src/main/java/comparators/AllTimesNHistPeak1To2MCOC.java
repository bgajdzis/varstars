...
public class AllTimesNHistPeak1To2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public AllTimesNHistPeak1To2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.AllTimesNHistPeak1To2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getAllTimesNHistPeak1To2();
            referenceValue = ((VarstarsRef) ref).getAllTimesNHistPeak1To2();
