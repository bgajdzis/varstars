...
public class Freq2RelPhase4MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq2RelPhase4MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq2RelPhase4;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq2RelPhase4();
            referenceValue = ((VarstarsRef) ref).getFreq2RelPhase4();
