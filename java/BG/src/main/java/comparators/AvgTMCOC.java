...
public class AvgTMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public AvgTMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.AvgT;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getAvgT();
            referenceValue = ((VarstarsRef) ref).getAvgT();
