...
public class CadsMeanMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadsMeanMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadsMean;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadsMean();
            referenceValue = ((VarstarsRef) ref).getCadsMean();
