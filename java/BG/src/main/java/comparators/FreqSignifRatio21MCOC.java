...
public class FreqSignifRatio21MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public FreqSignifRatio21MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.FreqSignifRatio21;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreqSignifRatio21();
            referenceValue = ((VarstarsRef) ref).getFreqSignifRatio21();
