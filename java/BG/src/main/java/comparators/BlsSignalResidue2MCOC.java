...
public class BlsSignalResidue2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsSignalResidue2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsSignalResidue2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsSignalResidue2();
            referenceValue = ((VarstarsRef) ref).getBlsSignalResidue2();
