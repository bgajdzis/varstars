...
public class BlsSignalDetectionEfficiency1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsSignalDetectionEfficiency1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsSignalDetectionEfficiency1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsSignalDetectionEfficiency1();
            referenceValue = ((VarstarsRef) ref).getBlsSignalDetectionEfficiency1();
