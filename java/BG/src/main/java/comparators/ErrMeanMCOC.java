...
public class ErrMeanMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public ErrMeanMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.ErrMean;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getErrMean();
            referenceValue = ((VarstarsRef) ref).getErrMean();
