...
public class StetsonMMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public StetsonMMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.StetsonM;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getStetsonM();
            referenceValue = ((VarstarsRef) ref).getStetsonM();
