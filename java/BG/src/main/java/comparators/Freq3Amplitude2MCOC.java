...
public class Freq3Amplitude2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq3Amplitude2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq3Amplitude2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq3Amplitude2();
            referenceValue = ((VarstarsRef) ref).getFreq3Amplitude2();
