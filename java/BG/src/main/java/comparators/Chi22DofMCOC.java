...
public class Chi22DofMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Chi22DofMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Chi22Dof;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getChi22Dof();
            referenceValue = ((VarstarsRef) ref).getChi22Dof();
