...
public class WeightedMeanMagMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public WeightedMeanMagMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.WeightedMeanMag;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getWeightedMeanMag();
            referenceValue = ((VarstarsRef) ref).getWeightedMeanMag();
