...
public class P2pScatterPfoldOverMadMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public P2pScatterPfoldOverMadMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.P2pScatterPfoldOverMad;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getP2pScatterPfoldOverMad();
            referenceValue = ((VarstarsRef) ref).getP2pScatterPfoldOverMad();
