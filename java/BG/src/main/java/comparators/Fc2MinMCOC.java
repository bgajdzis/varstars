...
public class Fc2MinMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Fc2MinMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Fc2Min;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFc2Min();
            referenceValue = ((VarstarsRef) ref).getFc2Min();
