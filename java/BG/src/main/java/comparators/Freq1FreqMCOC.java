...
public class Freq1FreqMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq1FreqMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq1Freq;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq1Freq();
            referenceValue = ((VarstarsRef) ref).getFreq1Freq();
