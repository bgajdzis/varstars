...
public class Freq1Amplitude2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq1Amplitude2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq1Amplitude2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq1Amplitude2();
            referenceValue = ((VarstarsRef) ref).getFreq1Amplitude2();
