...
public class BlsRedNoise1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsRedNoise1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsRedNoise1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsRedNoise1();
            referenceValue = ((VarstarsRef) ref).getBlsRedNoise1();
