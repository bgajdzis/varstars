...
public class Fold2pSlope90percentileMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Fold2pSlope90percentileMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Fold2pSlope90percentile;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFold2pSlope90percentile();
            referenceValue = ((VarstarsRef) ref).getFold2pSlope90percentile();
