...
public class Freq3Amplitude4MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq3Amplitude4MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq3Amplitude4;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq3Amplitude4();
            referenceValue = ((VarstarsRef) ref).getFreq3Amplitude4();
