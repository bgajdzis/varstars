...
public class BlsNPointsAfterTransit2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsNPointsAfterTransit2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsNPointsAfterTransit2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsNPointsAfterTransit2();
            referenceValue = ((VarstarsRef) ref).getBlsNPointsAfterTransit2();
