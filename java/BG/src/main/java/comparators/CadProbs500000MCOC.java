...
public class CadProbs500000MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public CadProbs500000MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.CadProbs500000;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getCadProbs500000();
            referenceValue = ((VarstarsRef) ref).getCadProbs500000();
