...
public class FluxPercentileRatio65MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public FluxPercentileRatio65MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.FluxPercentileRatio65;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFluxPercentileRatio65();
            referenceValue = ((VarstarsRef) ref).getFluxPercentileRatio65();
