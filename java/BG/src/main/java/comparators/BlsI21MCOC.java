...
public class BlsI21MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsI21MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsI21;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsI21();
            referenceValue = ((VarstarsRef) ref).getBlsI21();
