...
public class BlsPeriod1MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsPeriod1MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsPeriod1;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsPeriod1();
            referenceValue = ((VarstarsRef) ref).getBlsPeriod1();
