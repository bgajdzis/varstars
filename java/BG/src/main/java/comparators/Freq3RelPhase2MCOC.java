...
public class Freq3RelPhase2MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq3RelPhase2MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq3RelPhase2;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq3RelPhase2();
            referenceValue = ((VarstarsRef) ref).getFreq3RelPhase2();
