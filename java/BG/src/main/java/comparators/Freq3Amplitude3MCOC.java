...
public class Freq3Amplitude3MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public Freq3Amplitude3MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.Freq3Amplitude3;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getFreq3Amplitude3();
            referenceValue = ((VarstarsRef) ref).getFreq3Amplitude3();
