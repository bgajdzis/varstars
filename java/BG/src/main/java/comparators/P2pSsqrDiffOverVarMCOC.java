...
public class P2pSsqrDiffOverVarMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public P2pSsqrDiffOverVarMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.P2pSsqrDiffOverVar;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getP2pSsqrDiffOverVar();
            referenceValue = ((VarstarsRef) ref).getP2pSsqrDiffOverVar();
