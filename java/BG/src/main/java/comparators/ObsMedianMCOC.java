...
public class ObsMedianMCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public ObsMedianMCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.ObsMedian;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws ComparatorException {
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getObsMedian();
            referenceValue = ((VarstarsRef) ref).getObsMedian();
