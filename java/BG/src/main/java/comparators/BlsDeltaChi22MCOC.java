...
public class BlsDeltaChi22MCOC extends AbstractMonolithicCOComparator<VarstarFeatureSet> {


    public BlsDeltaChi22MCOC(String name) throws ComparatorException {
        super(name);
    }

    @Override
    public Integer getUniqueId() {
        return Constants.BlsDeltaChi22;
    }
    ...
    protected double getMembershipValue(IMonolithicReferenceObject ref) throws
        ...
        try {
            inputValue = ((VarstarsCO) getInputObject()).getBlsDeltaChi22();
            referenceValue = ((VarstarsRef) ref).getBlsDeltaChi22();
