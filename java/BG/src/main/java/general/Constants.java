...
public final class Constants {
    ...
    public static final Double perP = 0.7;
    ...
    public static final Class[] allDblComparators = {
            AmplitudeMCOC.class,
            PercentageAmplitudeMCOC.class,
            FluxPercentilePercentDifferenceMCOC.class,
            FluxPercentileRatio20MCOC.class,
            FluxPercentileRatio35MCOC.class,
            ...
            MaxObsMCOC.class,
            MinObsMCOC.class,
            PercentCloseToMedMCOC.class,
            ObsSkewMCOC.class,
            ObsStdMCOC.class,
            ObsMedianMCOC.class,
            PercentBeyond1SigmaMCOC.class,
            ErrWeightedAvgMCOC.class,
            StetsonMMCOC.class,
            StetsonKMCOC.class,
            StetsonJMCOC.class,
            //TotalTimeMCOC.class,
            ...
            CadProbs40MCOC.class,
            CadProbs50MCOC.class,
            CadProbs100MCOC.class,
            CadProbs500MCOC.class,
            CadProbs1000MCOC.class,
            CadProbs5000MCOC.class,
            CadProbs10000MCOC.class,
            CadProbs50000MCOC.class,
            CadProbs100000MCOC.class,
            CadProbs500000MCOC.class,
            ...
            AllTimesNHistPeak2To3MCOC.class,
            AllTimesNHistPeak1To4MCOC.class,
            AllTimesNHistPeak2To4MCOC.class,
            AllTimesNHistPeak3To4MCOC.class,
            ...
            Fold2pSlope10percentileMCOC.class,
            Fold2pSlope90percentileMCOC.class,
            Freq1Amplitude1MCOC.class,
            Freq1Amplitude2MCOC.class,
            Freq1Amplitude3MCOC.class,
            Freq1Amplitude4MCOC.class,
            Freq1FreqMCOC.class,
            Freq1LambdaMCOC.class,
            Freq1RelPhase2MCOC.class,
            Freq1RelPhase3MCOC.class,
            Freq1RelPhase4MCOC.class,
            Freq1SignifMCOC.class,
            Freq2Amplitude1MCOC.class,
            Freq2Amplitude2MCOC.class,
            Freq2Amplitude3MCOC.class,
            Freq2Amplitude4MCOC.class,
            Freq2FreqMCOC.class,
            Freq2RelPhase2MCOC.class,
            Freq2RelPhase3MCOC.class,
            Freq2RelPhase4MCOC.class,
            Freq3Amplitude1MCOC.class,
            Freq3Amplitude2MCOC.class,
            Freq3Amplitude3MCOC.class,
            Freq3Amplitude4MCOC.class,
            Freq3FreqMCOC.class,
            Freq3RelPhase2MCOC.class,
            Freq3RelPhase3MCOC.class,
            Freq3RelPhase4MCOC.class,
            FreqAmplitudeRatio21MCOC.class,
            FreqAmplitudeRatio31MCOC.class,
            FreqFrequencyRatio21MCOC.class,
            FreqFrequencyRatio31MCOC.class,
            FreqModelMaxDeltaMagsMCOC.class,
            FreqModelMinDeltaMagsMCOC.class,
            FreqModelPhi1Phi2MCOC.class,
            FreqNAliasMCOC.class,
            FreqSignifRatio21MCOC.class,
            FreqSignifRatio31MCOC.class,
            FreqVarratMCOC.class,
            FreqYOffsetMCOC.class,
            LinearTrendMCOC.class,
            Medperc902pPMCOC.class,
            P2pScatter2prawMCOC.class,
