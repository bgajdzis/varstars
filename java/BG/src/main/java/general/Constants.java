...
public final class Constants {
    ...
    public static final String SQLresultInsertHeader = "INSERT INTO predicted_types (name,type,value,run_id) VALUES";
    ...
    public static final Map<Class,Integer> allDblComparators = Stream.of(
            ...
            new SimpleEntry<Class,Integer>(FluxPercentilePercentDifferenceMCOC.class,1),
            ...
            new SimpleEntry<Class,Integer>(PercentCloseToMedMCOC.class,1),
            ...
            new SimpleEntry<Class,Integer>(PercentBeyond1SigmaMCOC.class,1),
            new SimpleEntry<Class,Integer>(ErrWeightedAvgMCOC.class,1),
            new SimpleEntry<Class,Integer>(StetsonMMCOC.class,1),
            new SimpleEntry<Class,Integer>(StetsonKMCOC.class,1),
            ...
            new SimpleEntry<Class,Integer>(PeriodFastMCOC.class,1),
            new SimpleEntry<Class,Integer>(QsoLogChi2QsoNuMCOC.class,1),
            ...
            new SimpleEntry<Class,Integer>(FreqAmplitudeRatio21MCOC.class,1),
            ...
            new SimpleEntry<Class,Integer>(FreqNAliasMCOC.class,1),
            ...
            new SimpleEntry<Class,Integer>(LinearTrendMCOC.class,1),
            new SimpleEntry<Class,Integer>(Medperc902pPMCOC.class,1),
            ...
            new SimpleEntry<Class,Integer>(BlsSignalToNoise1MCOC.class,1),
            new SimpleEntry<Class,Integer>(BlsSignalResidue1MCOC.class,1),
            new SimpleEntry<Class,Integer>(BlsSignalDetectionEfficiency1MCOC.class,1),
            new SimpleEntry<Class,Integer>(BlsDepth1MCOC.class,1),
            new SimpleEntry<Class,Integer>(BlsQTransit1MCOC.class,1),
            new SimpleEntry<Class,Integer>(BlsI11MCOC.class,1),
            new SimpleEntry<Class,Integer>(BlsI21MCOC.class,1),
            new SimpleEntry<Class,Integer>(BlsDeltaChi21MCOC.class,1),
            ...
            new SimpleEntry<Class,Integer>(AlarmMCOC.class,1),
            new SimpleEntry<Class,Integer>(Chi22DofMCOC.class,1),
