...
public final class Constants {
    ...
    public static final Map<Class, Integer> nonperiodicDblComparators = Stream.of(
            ...
            new SimpleEntry<Class, Integer>(FluxPercentileRatio50MCOC.class, 3),
            ...
            new SimpleEntry<Class, Integer>(MedianAbsStdMCOC.class, 2),
            ...
            new SimpleEntry<Class, Integer>(AllTimesNHistPeakValMCOC.class, 1),
    ...
    public static final Map<Class, Integer> periodicDblComparators = Stream.of(
            ...
            new SimpleEntry<Class, Integer>(Fold2pSlope10percentileMCOC.class, 2),
            new SimpleEntry<Class, Integer>(Fold2pSlope90percentileMCOC.class, 0),
            ...
            new SimpleEntry<Class, Integer>(Freq1FreqMCOC.class, 3),
            ...
            new SimpleEntry<Class, Integer>(FreqModelMaxDeltaMagsMCOC.class, 2),
            ...
            new SimpleEntry<Class, Integer>(WeightedMeanMagMCOC.class, 0),
            new SimpleEntry<Class, Integer>(NEpochsMCOC.class, 0),
            new SimpleEntry<Class, Integer>(Fc2FreqMCOC.class,  5),
