...
public final class Constants {
    ...
    public static final Map<Class, Integer> nonperiodicDblComparators = Stream.of(
            ...
            new SimpleEntry<Class, Integer>(PercentageAmplitudeMCOC.class, 1),
            new SimpleEntry<Class, Integer>(FluxPercentilePercentDifferenceMCOC.class, 0),
            new SimpleEntry<Class, Integer>(FluxPercentileRatio20MCOC.class, 0),
            new SimpleEntry<Class, Integer>(FluxPercentileRatio35MCOC.class, 0),
            new SimpleEntry<Class, Integer>(FluxPercentileRatio50MCOC.class, 1),
            new SimpleEntry<Class, Integer>(FluxPercentileRatio65MCOC.class, 0),
            new SimpleEntry<Class, Integer>(FluxPercentileRatio80MCOC.class, 0),
            ...
            new SimpleEntry<Class, Integer>(ErrMedianMCOC.class, 0),
            new SimpleEntry<Class, Integer>(ErrMeanMCOC.class, 0),
            new SimpleEntry<Class, Integer>(ErrStdMCOC.class, 0),
            new SimpleEntry<Class, Integer>(MaxAbsSlopeMCOC.class, 0),
            new SimpleEntry<Class, Integer>(MedianAbsStdMCOC.class, 1),
            new SimpleEntry<Class, Integer>(MaxObsMCOC.class, 0),
            new SimpleEntry<Class, Integer>(MinObsMCOC.class, 0),
            new SimpleEntry<Class, Integer>(PercentCloseToMedMCOC.class, 0),
            new SimpleEntry<Class, Integer>(ObsSkewMCOC.class, 1),
            new SimpleEntry<Class, Integer>(ObsStdMCOC.class, 1),
            new SimpleEntry<Class, Integer>(ObsMedianMCOC.class, 0),
            new SimpleEntry<Class, Integer>(PercentBeyond1SigmaMCOC.class, 0),
            new SimpleEntry<Class, Integer>(ErrWeightedAvgMCOC.class, 1),
            new SimpleEntry<Class, Integer>(StetsonMMCOC.class, 0),
            new SimpleEntry<Class, Integer>(StetsonKMCOC.class, 0),
            new SimpleEntry<Class, Integer>(StetsonJMCOC.class, 1),
            new SimpleEntry<Class, Integer>(TotalTimeMCOC.class, 0),
            new SimpleEntry<Class, Integer>(AvgTMCOC.class, 0),
            new SimpleEntry<Class, Integer>(MeanMCOC.class, 0),
            ...
            new SimpleEntry<Class, Integer>(AllTimesNHistNumpeaksMCOC.class, 1),
    ...
    public static final Map<Class, Integer> periodicDblComparators = Stream.of(
            ...
            new SimpleEntry<Class, Integer>(QsoLogChi2QsoNuMCOC.class, 0),
            new SimpleEntry<Class, Integer>(QsoLogChi2NuNullChi2NuMCOC.class, 1),
            new SimpleEntry<Class, Integer>(Fold2pSlope10percentileMCOC.class, 0),
            new SimpleEntry<Class, Integer>(Fold2pSlope90percentileMCOC.class, 2),
            new SimpleEntry<Class, Integer>(Freq1Amplitude1MCOC.class, 1),
            new SimpleEntry<Class, Integer>(Freq1Amplitude2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq1Amplitude3MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq1Amplitude4MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq1FreqMCOC.class, 1),
            new SimpleEntry<Class, Integer>(Freq1LambdaMCOC.class, 1),
            new SimpleEntry<Class, Integer>(Freq1RelPhase2MCOC.class, 2),
            new SimpleEntry<Class, Integer>(Freq1RelPhase3MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq1RelPhase4MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq1SignifMCOC.class, 2),
            new SimpleEntry<Class, Integer>(Freq2Amplitude1MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq2Amplitude2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq2Amplitude3MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq2Amplitude4MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq2FreqMCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq2RelPhase2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq2RelPhase3MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq2RelPhase4MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq3Amplitude1MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq3Amplitude2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq3Amplitude3MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq3Amplitude4MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq3FreqMCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq3RelPhase2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq3RelPhase3MCOC.class, 0),
            new SimpleEntry<Class, Integer>(Freq3RelPhase4MCOC.class, 0),
            new SimpleEntry<Class, Integer>(FreqAmplitudeRatio21MCOC.class, 0),
            new SimpleEntry<Class, Integer>(FreqAmplitudeRatio31MCOC.class, 0),
            new SimpleEntry<Class, Integer>(FreqFrequencyRatio21MCOC.class, 0),
            new SimpleEntry<Class, Integer>(FreqFrequencyRatio31MCOC.class, 0),
            new SimpleEntry<Class, Integer>(FreqModelMaxDeltaMagsMCOC.class, 0),
            new SimpleEntry<Class, Integer>(FreqModelMinDeltaMagsMCOC.class, 0),
            new SimpleEntry<Class, Integer>(FreqModelPhi1Phi2MCOC.class, 1),
            new SimpleEntry<Class, Integer>(FreqNAliasMCOC.class, 0),
            new SimpleEntry<Class, Integer>(FreqSignifRatio21MCOC.class, 1),
            new SimpleEntry<Class, Integer>(FreqSignifRatio31MCOC.class, 0),
            new SimpleEntry<Class, Integer>(FreqVarratMCOC.class, 0),
            new SimpleEntry<Class, Integer>(FreqYOffsetMCOC.class, 0),
            new SimpleEntry<Class, Integer>(LinearTrendMCOC.class, 0),
            new SimpleEntry<Class, Integer>(Medperc902pPMCOC.class, 0),
            new SimpleEntry<Class, Integer>(P2pScatter2prawMCOC.class, 1),
            new SimpleEntry<Class, Integer>(P2pScatterOverMadMCOC.class, 0),
            new SimpleEntry<Class, Integer>(P2pScatterPfoldOverMadMCOC.class, 0),
            new SimpleEntry<Class, Integer>(P2pSsqrDiffOverVarMCOC.class, 0),
            new SimpleEntry<Class, Integer>(ScatterResRawMCOC.class, 0),
            ...
            new SimpleEntry<Class, Integer>(BlsSignalResidue1MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsSignalDetectionEfficiency1MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsDepth1MCOC.class, 1),
            new SimpleEntry<Class, Integer>(BlsQTransit1MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsI11MCOC.class, 2),
            new SimpleEntry<Class, Integer>(BlsI21MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsDeltaChi21MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsFracOneNight1MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsNPointsInTransit1MCOC.class, 1),
            new SimpleEntry<Class, Integer>(BlsNTransits1MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsNPointsBeforeTransit1MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsNPointsAfterTransit1MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsRedNoise1MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsWhiteNoise1MCOC.class, 1),
            new SimpleEntry<Class, Integer>(BlsSignalToPinkNoise1MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsPeriod2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsTc2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsSignalToNoise2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsSignalResidue2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsSignalDetectionEfficiency2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsDepth2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsQTransit2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsI12MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsI22MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsDeltaChi22MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsFracOneNight2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsNPointsInTransit2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsNTransits2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsNPointsBeforeTransit2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsNPointsAfterTransit2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsRedNoise2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsWhiteNoise2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsSignalToPinkNoise2MCOC.class, 0),
            new SimpleEntry<Class, Integer>(PeriodInverseTransitMCOC.class, 1),
            new SimpleEntry<Class, Integer>(DeltaChi2InverseTransitMCOC.class, 0),
            new SimpleEntry<Class, Integer>(BlsMeanMagMCOC.class, 0),
            new SimpleEntry<Class, Integer>(AlarmMCOC.class, 0),
            ...
            new SimpleEntry<Class, Integer>(Fc2MinMCOC.class, 2),
            ...
            new SimpleEntry<Class, Integer>(CkpIpMCOC.class, 2),
